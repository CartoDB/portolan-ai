              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="text-sm font-medium text-portolan-blue group-hover:text-portolan-cyan transition-colors">
                      {card.label}
                    </h4>
                    {card.description && (
                    ...
                    {card.url && (
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-xs text-portolan-green mt-1.5 hover:underline truncate max-w-full"
                      >
