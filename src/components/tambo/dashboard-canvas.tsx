...
const INTERACTABLE_NAMES = new Set(["GeoMap", "Graph", "DataTable", "TimeSlider"]);
  ...
  return (
    <div
      ...
      className={cn(
        ...
        minH,
        isDragging && "ring-2 ring-portolan-blue/40 opacity-80 shadow-lg z-50",
      ...
      <div className="flex items-center gap-2 px-3 py-1.5 border-b border-border/30 bg-muted/10 flex-shrink-0 select-none">
        <div
          ...
          className={cn(
            ...
            isDragging ? "text-portolan-blue" : "text-muted-foreground/30 active:text-portolan-blue",
          )}
        >
    ...
    return (
      ...
      >
        <div className="text-center space-y-6 px-8 flex flex-col items-center">
          <img src={`${basePath}/portolan-logo.svg`} alt="Portolan" width={48} height={48} className="opacity-20" />
