        ...
        <div className="px-4 pb-4">
          ...
          <form onSubmit={addServer} className="mb-8">
            ...
            <div className="mt-6 pt-4 border-t border-muted">
              <p className="text-xs font-semibold text-muted-foreground mb-2 uppercase tracking-wide">Quick add</p>
              <button
                type="button"
                onClick={() => {
                  setServerName("MotherDuck");
                  setTransportType(MCPTransport.SSE);
                  setServerUrl("https://your-motherduck-mcp-endpoint");
                }}
                className="px-3 py-1.5 text-sm border border-muted rounded-md hover:bg-muted-backdrop focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1 cursor-pointer transition-all duration-150 text-foreground"
              >
                MotherDuck
              </button>
              <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
                Optional. Routes heavier queries to MotherDuck cloud while the default query path stays in-browser
                DuckDB-wasm. Supply your own MotherDuck endpoint URL and access token, then click Add Server.
              </p>
            </div>
          ...
          {/* Success Message */}
          {savedSuccess && (
            <div className="mb-6 p-3 bg-portolan-green/10 border border-portolan-green/20 text-portolan-green rounded-lg text-sm animate-in slide-in-from-top-1 duration-200">
              <div className="flex items-center">
                <span className="text-portolan-green mr-2">✓</span>
                        ...
                        <div className="flex items-center mb-1">
                          <div
                            className={cn(
                              ...
                              status === "connected" && "bg-portolan-green",
                          ...
                          <span
                            className={cn(
                              ...
                              status === "connected" && "bg-portolan-green/10 text-portolan-green",
