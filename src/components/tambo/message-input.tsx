        ...
        >
          <div
            className={cn(
              ...
              isDragging ? "border border-dashed border-portolan-green" : "border border-border",
            )}
          >
            {isDragging && (
              <div className="absolute inset-0 rounded-xl bg-portolan-green/10 flex items-center justify-center pointer-events-none z-20">
                <p className="text-portolan-green font-medium">Drop files here to add to conversation</p>
              </div>
            )}
            {elicitation ? (
