          ...
          {columns && columns.length > 0 && (
            <div className="mt-3">
              <button
                ...
                className="text-xs text-portolan-blue hover:text-portolan-cyan transition-colors"
              >
                ...
                <div className="mt-2 space-y-1">
                  {columns.map((col) => (
                    <div key={col.id} className="flex items-start gap-2 text-xs">
                      <code className="font-mono text-portolan-blue bg-portolan-blue/5 px-1.5 py-0.5 rounded flex-shrink-0">
                        {col.name}
                      </code>
          ...
          {sourceUrl && (
            <div className="mt-3">
              <a
                ...
                className="text-xs text-portolan-blue hover:underline"
              >
                View source data →
              </a>
            </div>
